...
$(function() {
	...
	// 버튼 마우스 오버 시 커서 변환
	$("#btnmove").mouseover(function() {
		$("#btnmove").css("cursor", "pointer")
	})
...
<div id="welWrap">
	<h1>KH 커뮤니티</h1>
	<div class="imgWrap" >
		<img alt="img" src="../resources/img/chk.png" >
	</div>
	<span id="sentence">당신의 활약을 기대할게요!!</span>
		<label>
			<button type=button id="btnmove" onclick="location.href='/kh/Login'">Log in 페이지 이동하기</button>
		</label>
	<div id="siteInfo">
